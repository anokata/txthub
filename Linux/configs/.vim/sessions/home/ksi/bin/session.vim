...
set shortmess=aoO
badd +1 ~/pythonPetProjects/statpyloc.txt
badd +1 ~/pythonPetProjects/_autostart.py
badd +129 ~/.vimrc
badd +1 ~/pythonPetProjects/quest/tests/test_map_util.py
badd +1 ~/pythonPetProjects/zametki/currency.py
badd +1 ~/bin/weather.sh
badd +1 ~/start_end.log
argglobal
silent! argdel *
argadd ~/pythonPetProjects/statpyloc.txt
edit ~/bin/weather.sh
