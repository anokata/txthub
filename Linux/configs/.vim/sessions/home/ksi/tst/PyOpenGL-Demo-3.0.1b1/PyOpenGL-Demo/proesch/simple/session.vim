...
silent only
cd ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/proesch/simple
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/proesch/simple/simpleInteraction.py
argglobal
silent! argdel *
argadd simpleInteraction.py
set stal=2
edit ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/proesch/simple/simpleInteraction.py
