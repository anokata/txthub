...
silent only
cd ~/pythonPetProjects/surgame
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/pythonPetProjects/surgame/setup.py
badd +0 ~/pythonPetProjects/surgame/README.txt
argglobal
silent! argdel *
argadd setup.py
edit ~/pythonPetProjects/surgame/setup.py
