...
silent only
cd ~/Downloads/Win10.x86-x64.Rus-Eng.20in1.KMS-activation
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/Downloads/Win10.x86-x64.Rus-Eng.20in1.KMS-activation/readme.txt
argglobal
silent! argdel *
argadd readme.txt
edit ~/Downloads/Win10.x86-x64.Rus-Eng.20in1.KMS-activation/readme.txt
...
silent! normal! zE
let s:l = 57 - ((22 * winheight(0) + 19) / 39)
