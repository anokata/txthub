...
silent only
cd ~/pythonPetProjects/var_scripts
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/pythonPetProjects/var_scripts/wgetpage.py
badd +1 ~/ydsk/txthub/TZ_webcat.txt
badd +1 ~/pythonPetProjects/weather/weather.py
badd +0 ~/pythonPetProjects/_autostart.py
argglobal
silent! argdel *
argadd wgetpage.py
set stal=2
edit ~/pythonPetProjects/var_scripts/wgetpage.py
...
let s:l = 29 - ((14 * winheight(0) + 11) / 22)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
29
normal! 02|
tabedit ~/pythonPetProjects/_autostart.py
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
70
normal! zo
let s:l = 75 - ((27 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
75
normal! 067|
tabedit ~/ydsk/txthub/TZ_webcat.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
