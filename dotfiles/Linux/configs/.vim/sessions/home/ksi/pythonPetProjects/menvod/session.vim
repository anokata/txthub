...
silent only
cd ~/pythonPetProjects/menvod
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/pythonPetProjects/menvod/main.py
badd +22 ~/pythonPetProjects/modules/gl_main.py
badd +4 ~/pythonPetProjects/quest/quest.py
badd +0 ~/pythonPetProjects/modules/ByteFont.py
badd +74 ~/pythonPetProjects/quest/render.py
badd +0 ~/pythonPetProjects/menvod/Makefile
badd +0 ~/pythonPetProjects/menvod/TZ_fileManager.txt
badd +0 ~/pythonPetProjects/menvod/TZ_menvod.org
argglobal
silent! argdel *
argadd main.py
set stal=2
edit ~/pythonPetProjects/menvod/main.py
...
10
normal! 049|
tabedit ~/pythonPetProjects/menvod/TZ_fileManager.txt
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
1
normal! 0
tabedit ~/pythonPetProjects/menvod/TZ_menvod.org
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
