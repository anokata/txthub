...
silent only
cd ~/pythonPetProjects/zametki
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 ~/pythonPetProjects/zametki/pystore_client.py
badd +1 ~/pythonPetProjects/_autostart.py
badd +1 ~/pythonPetProjects/zametki/pystore_server.py
badd +1 ~/pythonPetProjects/zametki/TZ.org
badd +1 ~/bin/_autostart.py
argglobal
silent! argdel *
argadd pystore_client.py
set stal=2
edit ~/pythonPetProjects/zametki/pystore_client.py
...
137
normal! zo
let s:l = 72 - ((25 * winheight(0) + 18) / 37)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
72
normal! 013|
tabedit ~/pythonPetProjects/zametki/TZ.org
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
