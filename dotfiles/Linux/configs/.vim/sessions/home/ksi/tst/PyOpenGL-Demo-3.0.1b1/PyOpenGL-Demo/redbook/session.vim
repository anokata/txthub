...
silent only
cd ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/redbook
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +0 ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/redbook/movelight.py
argglobal
silent! argdel *
argadd movelight.py
edit ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/redbook/movelight.py
...
silent! normal! zE
let s:l = 142 - ((37 * winheight(0) + 19) / 39)
