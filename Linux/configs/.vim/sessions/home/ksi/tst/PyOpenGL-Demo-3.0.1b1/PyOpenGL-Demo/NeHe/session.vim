...
silent only
cd ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/NeHe
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +120 ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/NeHe/lesson1.py
badd +0 ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/NeHe/lesson2.py
argglobal
silent! argdel *
argadd lesson1.py
edit ~/tst/PyOpenGL-Demo-3.0.1b1/PyOpenGL-Demo/NeHe/lesson2.py
